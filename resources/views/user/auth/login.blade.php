                    ...
                    <div class="card-body p-md-5 mx-md-4">
                      ...
                      <form action="{{ route('user.login.attempt') }}" method="POST">
                        ...
                        <div class="text-center pt-1 mb-5 pb-1">
                          ...
                          <a class="text-muted" href="{{ route('password.request') }}">{{ __('messages.Forgot password') }}</a>
                        </div>
                      
                        <div class="d-flex align-items-center justify-content-center pb-4">
                          <p class="mb-0 me-2">{{ __('messages.Don\' t have an account') }}</p>
                          <a href="{{ route('user.register') }}" class="btn btn-outline-danger">{{ __('messages.Sign up') }}</a>
                        </div>
                      </form>
                    </div>
                  </div>
